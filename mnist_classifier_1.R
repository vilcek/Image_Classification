...
# in the following 2 lines you sample indices from the data set; it is set to sample 1%
idx_train <- sample(1:dim(train_X)[1], trunc(dim(train_X)[1]*1/100))
idx_test <- sample(1:dim(test_X)[1], trunc(dim(test_X)[1]*1/100))
